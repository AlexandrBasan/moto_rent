  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved airport as @airport" do
        ...
        post :create, {:airport => { "code" => "invalid value" }}, valid_session
        assigns(:airport).should be_a_new(Airport)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested airport" do
        ...
        Airport.any_instance.should_receive(:update).with({ "code" => "MyString" })
        put :update, {:id => airport.to_param, :airport => { "code" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the airport as @airport" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Airport.any_instance.stub(:save).and_return(false)
        put :update, {:id => airport.to_param, :airport => { "code" => "invalid value" }}, valid_session
        assigns(:airport).should eq(airport)
      end
