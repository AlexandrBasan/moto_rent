  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved supplier as @supplier" do
        ...
        post :create, {:supplier => { "user_id" => "invalid value" }}, valid_session
        assigns(:supplier).should be_a_new(Supplier)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested supplier" do
        ...
        Supplier.any_instance.should_receive(:update).with({ "user_id" => "1" })
        put :update, {:id => supplier.to_param, :supplier => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the supplier as @supplier" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Supplier.any_instance.stub(:save).and_return(false)
        put :update, {:id => supplier.to_param, :supplier => { "user_id" => "invalid value" }}, valid_session
        assigns(:supplier).should eq(supplier)
      end
