...
module Liqpay
  class Liqpay
    ...
    def cnb_signature(params = {})
      ...
      # my code
      sign_str << params[:phone].to_s if params.key? :phone
      sign_str << params[:card].to_s if params.key? :card
      sign_str << params[:card_exp_month].to_s if params.key? :card_exp_month
      sign_str << params[:card_exp_year].to_s if params.key? :card_exp_year
      sign_str << params[:card_cvv].to_s if params.key? :card_cvv
